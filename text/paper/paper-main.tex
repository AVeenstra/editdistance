...
\newcommand\todo[1]{\textcolor{red}{Todo: #1\ref*{:#1}}}
...
\keywords{OpenCL, Edit distance problem, Levenshtein distance problem, GPU cluster, C++, case study, GPGPU program, MPI, Message Passing Interface}
