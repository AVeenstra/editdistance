...
\algnewcommand\invariant[1]{{\color{jml}\Statex{\textbf{invariant} #1}}}
\algnewcommand\requires[1]{{\color{jml}\Statex{\textbf{requires} #1}}}
\algnewcommand\globalrequires[1]{{\color{jml}\Statex{\textbf{global requires} #1}}}
\algnewcommand\ensures[1]{{\color{jml}\Statex{\textbf{ensures} #1}}}
\algnewcommand\globalensures[1]{{\color{jml}\Statex{\textbf{global ensures} #1}}}
\algnewcommand\loopinv[1]{{\color{jml}\Statex{\textbf{loop\_invariant} #1}}}
\algnewcommand\context[1]{{\color{jml}\Statex{\textbf{context} #1}}}
